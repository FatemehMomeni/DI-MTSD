    ...
    for target_index in range(len(target_word_pair)):
        ...
        for seed in random_seeds:
            ...
            if train_mode == "unified":
                ...
                x_train, y_train, x_train_target, y_train2, x_train_target2 = pp.clean_all(filename1, col,
                                                                                           normalization_dict)
                x_val, y_val, x_val_target, y_val2, x_val_target2 = pp.clean_all(filename2, col, normalization_dict)
                x_test, y_test, x_test_target, y_test2, x_test_target2 = pp.clean_all(filename3, col,
                                                                                      normalization_dict)
