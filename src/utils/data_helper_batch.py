...
def data_helper_bert(data, batch_size, mode):
  ...
  encoded_tar = tokenizer(data[2], max_length=128, padding='max_length', truncation=True)    
  encoded_txt = tokenizer(data[0], max_length=128, padding='max_length', truncation=True)
